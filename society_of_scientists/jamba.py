...
groupchat = autogen.GroupChat(
    agents=[ontologist, planner, assistant, scientist, hypothesis_agent, outcome_agent, mechanism_agent, design_principles_agent, unexpected_properties_agent, comparison_agent, novelty_agent, critic_agent],
      messages=[], 
      max_round=10, 
      admin_name='user', 
